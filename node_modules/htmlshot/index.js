...
((w,shot,fs,m)=>{
    class ___{
      ...
      constructor(selector,fn){
         this.ui=selector.ui || selector;
         this.options=(typeof selector ==="object")?selector:{};
         this.options.mimetype=this.options.mimetype || "image/png";
         this.onReady=fn;
         this.init_client();
         this.init_server();
         return this;
      ...
      init_server(){
          if(typeof this.ui ==='string' && this.ui.indexOf('data:image/')===0){
            fs.writeFileSync(this.onReady+"."+this.options.mimetype.split('/')[1], new Buffer(this.ui.replace(/^data:image\/(png|gif|jpeg);base64,/,''), "base64"));
      ...
      init_client(){
        ...
        if(typeof w !== 'undefined' && typeof m ==="undefined"){
          var that=this;
          let ui=(this.ui instanceof HTMLElement)?this.ui:document.querySelectorAll(this.ui);
           this.options.onrendered=function(cnv){
                   that.base64=cnv.toDataURL(that.options.mimetype,that.options.quality || 1.0);

                   return (typeof that.onReady === 'function') && that.onReady(that.base64);
           };

           shot(ui,this.options);
...
})((typeof window ==='object')?window:null,(typeof require ==='function')?require('./lib/shor.js'):function(){return html2canvas(...arguments)},(typeof require==='function')?require('fs'):'',(typeof module==='undefined')?null:module)
